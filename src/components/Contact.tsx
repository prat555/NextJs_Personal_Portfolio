...
export default function Contact() {
  ...
  return (
    <section id="contact" aria-label="Contact Information" className="py-12 md:py-16 pb-28 md:pb-16 bg-white dark:bg-gray-800">
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-center md:text-left mb-4 md:mb-0">
              <p className="text-gray-600 dark:text-gray-300">© 2026 Pratyush Goutam. All rights reserved.</p>
            </div>
            <div className="flex space-x-6">
              {socialLinks.map((link, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="text-gray-600 dark:text-gray-300 hover:text-accent transition-colors duration-300 relative group"
